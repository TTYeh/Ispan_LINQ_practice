...
namespace Ispan_LinQPractice_WinApp {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TestTable2DataTable : global::System.Data.TypedTableBase<TestTable2Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TestTable2Row AddTestTable2Row(int Num) {
        ...
        public partial class TestTable2Row : global::System.Data.DataRow {
            ...
            public int Num {
                get {
                    return ((int)(this[this.tableTestTable2.NumColumn]));
                }
                set {
                    this[this.tableTestTable2.NumColumn] = value;
                }
            }
        }
...
namespace Ispan_LinQPractice_WinApp.DataSet1TableAdapters {
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ispan_LinQPractice_WinApp.Properties.Settings.Default.NorthwindConnectionString;
        }
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT  FirstName + \' \' + LastName AS Expr1\r\nFROM      Employees";
        ...
        public virtual int FillBy(DataSet1.EmployeesDataTable dataTable) {
        ...
        public virtual DataSet1.EmployeesDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSet1.EmployeesDataTable dataTable = new DataSet1.EmployeesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
...
SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)";
    ...
    public partial class TestTable2TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [TestTable2] ([Num]) VALUES (@Num)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT  Num\r\nFROM      TestTable2";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DataSet1.TestTable2DataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet1.TestTable2DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.TestTable2DataTable dataTable = new DataSet1.TestTable2DataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.TestTable2DataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int Num) {
